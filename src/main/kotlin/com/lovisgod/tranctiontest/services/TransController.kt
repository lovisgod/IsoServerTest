...
//            log.info("RespMsg {}", respMsg)
    ...
    fun do200ToIsw(
        ...
        return try {
            ...
            request[49] = "566"
            request[55] = transactionRequest.iccString
...
//                request.unset( 33)
            ...
            val newMessage = request
            var data = javaClass.getResourceAsStream("/nibss_new.xml")
            var packager = GenericPackager(data)
            newMessage.packager = packager
            val bytes = newMessage.pack()
            ...
            val sessionKey = "B385B5C8202AEF34464FDC7A626854BA"
...
//            }
//
//            val sessionKey = "106D764FB3947032627089A7E96149A4"
//            val hashValue = IsoUtils.getMac(sessionKey, temp) //SHA256
//            request.set(128, hashValue)
            printISOMessage(request)
