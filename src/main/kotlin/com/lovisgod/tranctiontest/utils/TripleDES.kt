...
import HexUtil
import com.lovisgod.tranctiontest.utils.IsoUtils.bytesToHex
import com.lovisgod.tranctiontest.utils.IsoUtils.hexToBytes
...
class TripleDES(var key: String) {
    companion object {
        ...
        return bytesToHex(plaintext);*/
            ...
            println(HexUtil.parseHex(encrypted).size)
            val decrypted = cipher.doFinal(HexUtil.parseHex(encrypted))
